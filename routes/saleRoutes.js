...
const { sanitizeBody, validateSale, validateCartSale } = require('../middleware/validation');
...
router.post('/api/registrar-venta-carrito', requireLogin, sanitizeBody, validateCartSale, SaleController.registerCartSale);
